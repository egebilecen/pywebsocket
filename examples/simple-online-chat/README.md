This is a simple example of online chat system using websocket server. Be sure to update first line of "server/server.py" if pywebsocket folder contains class files but not the whole repo.
<br><br>
<b>Note:</b>
